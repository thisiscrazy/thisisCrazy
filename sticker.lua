      ...
      if data[tostring(msg.to.id)] then
        ...
        elseif matches[1] == 'sticker' then
          if matches[2] == 'warn' then
            ...
            return 'طھظ… طھظپط¹ظٹظ„ ط­ط¸ط± ط§ظ„ظ…ظ„طµظ‚ط§طھ.\n'
                   ..'ط³ظˆظپ ظٹطھظ… طھظ†ط¨ظٹظ‡ ط§ظˆظ„ط§ ط«ظ… ط§ظ„ط­ط¸ط± ط¨ظ„ط§ظ†طھظ‡ط§ظƒ ط§ظ„ط«ط§ظ†ظٹ.'
          elseif matches[2] == 'kick' then
            if settings.sticker ~= 'kick' then
              settings.sticker = 'kick'
              save_data(_config.moderation.data, data)
            end
            return 'طھظ… طھظپط¹ظٹظ„.\nظ…ظ†ط¹ ط§ظ„ظ…ظ„طµظ‚ط§طھ ط¨ظ„ط­ط¸ط±'
          elseif matches[2] == 'ok' then
            if settings.sticker == 'ok' then
              return 'ط§ظ†ظ‡ ظ…ط¹ط·ظ„ ط¨ظ„ظپط¹ظ„'
            else
              settings.sticker = 'ok'
              save_data(_config.moderation.data, data)
              return 'طھظ… طھط¹ط·ظٹظ„'
            end
          end
